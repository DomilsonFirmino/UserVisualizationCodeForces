...
function About(){
    return (
        <div className="container">
            <h2 style={{color: "var(--clr-pop)", marginBottom: "1rem"}}>Sobre Esta pagina</h2>
            <p style={{marginBottom: ".5rem"}}>
                ...
                Nossa plataforma é dedicada a ser uma ferramenta valiosa para impulsionar o progresso e o envolvimento ativo na programação competitiva.
            </p>
            <p>
